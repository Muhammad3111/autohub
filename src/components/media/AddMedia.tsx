  ...
  return (
    <form onSubmit={handleSubmit} className="p-4">
      ...
      <div className="w-full flex justify-end mt-4">
        <button
          type="submit"
          className="w-max mt-1 text-base bg-indigo-600 text-white py-2 px-4 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
          disabled={
            files.length === 0 ||
