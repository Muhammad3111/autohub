      ...
      <div className="flex justify-between gap-10 mt-10">
        <div className="w-[850px] mt-[9px]">
          <div className="w-full h-10 border-b flex items-center gap-10 text-xl">
            <button
              className={`${
                activeTab === "recommend" ? "text-primary" : "text-gray-500"
              }`}
            ...
            <button
              className={`${
                activeTab === "new-car" ? "text-primary" : "text-gray-500"
              }`}
            ...
            <button
              className={`${
                activeTab === "luxury-car" ? "text-primary" : "text-gray-500"
              }`}
          ...
          <div className="flex flex-col gap-5 mt-5">
            {videosData.map((data, index) => (
              <div key={index} className="cursor-pointer flex items-end gap-5">
                <video
                  src={data.video}
                  width={160}
