      ...
      <div className="flex justify-between gap-20 mt-10">
          ...
          <div className="flex flex-col justify-start gap-6 mt-5">
            {posts.length > 0 ? (
              posts.map((data) => (
                ...
                >
                  {data.video_link ? (
                    <VideoPlayer width="250" height="150" url={data.video_link} />
                  ) : (
                    <Image
                      width={200}
                      src={data.cover_image || "post-image"}
                      alt={data.title_uz}
                    />
                  )}
                  <div>
                    <h2 className="text-xl font-medium">
                      {data.title_uz.length >= 33
                        ? `${data.title_uz.slice(0, 33)}...`
                        : data.title_uz}
                    </h2>
                    <p className="text-gray-400">
                      {data.content_uz.length >= 33
                        ? `${data.content_uz.slice(0, 33)}...`
                        : data.content_uz}
                    </p>
                  </div>
        ...
        <div className="flex-1">
          ...
          <Section
            ...
            salesData={[...(carsData?.items || [])].reverse().slice(0, 3)}
          />
        </div>
      </div>
    </div>
