      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="flex gap-10 items-center col-span-1 shadow-lg rounded-xl p-6 border-2">
          ...
          <div className="flex flex-col items-start gap-2">
            <h1 className="text-2xl text-black">{counts.vehicle}</h1>
        ...
        <div className="flex gap-10 items-center col-span-1 shadow-lg rounded-xl p-6 border-2">
          ...
          <div className="flex flex-col items-start gap-2">
            <h1 className="text-2xl text-black">{counts.spare_part}</h1>
            <p className="text-base text-gray-400">Ehtiyot qisimlar</p>
          </div>
        </div>
        <div className="flex gap-10 items-center col-span-1 shadow-lg rounded-xl p-6 border-2">
          <div>
          ...
          <div className="flex flex-col items-start gap-2">
            <h1 className="text-2xl text-black">{counts.article}</h1>
        ...
        <div className="flex gap-10 items-center col-span-1 shadow-lg rounded-xl p-6 border-2">
          ...
          <div className="flex flex-col items-start gap-2">
            <h1 className="text-2xl text-black">{counts.test_drive}</h1>
            <p className="text-base text-gray-400">Test Drive So'rovlar</p>
          </div>
        </div>
        <div className="flex gap-10 items-center col-span-1 shadow-lg rounded-xl p-6 border-2">
          <div>
          ...
          <div className="flex flex-col items-start gap-2">
            ...
            <p className="text-base text-gray-400">Commentariyalar</p>
          </div>
        </div>
        <div className="flex gap-10 items-center col-span-1 shadow-lg rounded-xl p-6 border-2">
          <div>
          ...
          <div className="flex flex-col items-start gap-2">
            ...
            <p className="text-base text-gray-400">Foydalanuvchilar</p>
          </div>
        </div>
      </div>
    </div>
