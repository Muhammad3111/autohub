...
const DealerProfile = ({ userData }: DealerProfileProps) => {
  ...
  const handleSave = async () => {
    ...
    try {
      await updateAuth({
        staff_data: updatedFields.staff_data, // ✅ Endi bu to‘g‘ri
      }).unwrap();
  ...
  return (
    <div className="w-full h-full border border-[#ccc] rounded-md p-10 mb-10">
      ...
      <div className="flex justify-between w-full gap-52">
        <div className="w-48 h-48 rounded-full overflow-hidden bg-gray-200 relative mx-auto">
          {formState.avatar ? (
            <img
        ...
        <div className="flex-1 h-52 bg-gray-200 rounded-md flex items-center justify-center relative">
          {banner ? (
            <img
              src={banner}
              alt="Banner"
      ...
      <div className="flex flex-col gap-10 mt-10">
        <div className="grid grid-cols-2 flex-1 gap-10">
          ...
          <div className="flex flex-col w-full gap-1">
            <label htmlFor="region" className="font-semibold text-gray-500">
              Viloyat
            </label>
            <input
              type="text"
          ...
          <div className="flex flex-col w-full gap-1">
            <label htmlFor="city" className="font-semibold text-gray-500">
              Shahar
            </label>
            <input
              type="text"
