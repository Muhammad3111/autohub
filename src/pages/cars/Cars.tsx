...
const Cars = () => {
  ...
  const { data: carsData, isLoading, isSuccess } = useGetCarsQuery({ page: 1 });
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-4 p-10">
          <h1 className="text-4xl font-semibold inline-flex gap-2 justify-center flex-wrap">
            ...
            <span className="text-primary">{t("cars-page.car-brands")}</span>
          </h1>
          ...
          <div className="col-span-full flex justify-center">
            <Link to={"/brands"}>
              <Button className="px-4">{t("cars-page.see-all-brands")}</Button>
            </Link>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4 p-10 bg-white">
          <h1 className="text-4xl font-semibold text-center mb-4">
            ...
            <span className="text-primary">{t("cars-page.header-title")}</span>
          </h1>
