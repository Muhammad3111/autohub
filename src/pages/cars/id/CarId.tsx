                        ...
                        <div className='flex flex-col gap-4'>
                            ...
                            <div className='grid grid-cols-2 gap-4'>
                                <p className='col-span-1 text-xl text-gray-500'>
                                    Ishlab chiqaruvchi: {car.brand?.name}
                                </p>
                                <p className='col-span-1 text-xl text-gray-500'>
                                    Daraja: O'rtacha va uzun avtomobil
                                </p>
                                <p className='col-span-1 text-xl text-gray-500'>
                                    Bosib o'tish masofasi: 460km
                                </p>
                                <p className='col-span-1 text-xl text-gray-500'>
                                    Tezkor zaryadlash: 0.32h
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className='flex flex-col mt-4 w-full'>
                                {visibleComments.map((comment) => (
                                    <div
                                        key={comment.id}
                                        className='py-4 first:border-t border-b last:border-b-0 flex gap-2 relative min-h-32 w-full'
                                    >
                                        ...
                                        <div className='flex flex-col w-full max-w-[600px] break-words overflow-x-hidden'>
